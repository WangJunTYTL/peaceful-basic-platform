...
public class MailHelper {
    ...
    static {
        props.put("mail.smtp.auth", Application.getConfigContext().getString("mail.smtp.auth"));
        props.put("mail.smtp.host", Application.getConfigContext().getString("mail.smtp.host"));
        props.setProperty("mail.transport.protocol", "smtp");
        props.setProperty("mail.debug", "false");
        username = Application.getConfigContext().getString("mail.user");
        password = Application.getConfigContext().getString("mail.password");
        mailHost = Application.getConfigContext().getString("mail.smtp.host");
    }
